              ...
              <Slider {...settings}>
                  ...
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="#">
                            <i className="fa fa-comments-o" /> 09
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <i className="fa fa-tags" /> News
                          </a>
                        </li>
                      </ul>
                      <p>
                        Lorem ipsum dolor sit amet,consectetur adipisicing
                        elit,sed eiusmod tempor incididunt ut labore et dolor
                        emagna eliqua.
                      </p>
                    </div>
                ...
                <div className="col-lg-12">
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      <h3>
                        <a href="#">Tour: The New York Bicycles Workshop</a>
                      </h3>
                      <ul>
                        <li>
                          <a href="#">
                ...
                <div className="col-lg-12">
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      <h3>
                        <a href="#">
                          10 weird and wonderful derailleurs and changed cycling
                        </a>
                      </h3>
                      <ul>
                        <li>
                ...
                <div className="col-lg-12">
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      <h3>
                        <a href="#">
                          It&apos; time football started to take cycling
                          seriously
                        </a>
                      </h3>
                      <ul>
                ...
                <div className="col-lg-12">
                  <div className="single-blog-post">
                    ...
                    <div className="post-content">
                      <h3>
                        <a href="#">
                          10 pro tips for surviving a 100-mile bike ride
                        </a>
                      </h3>
                      <ul>
                        <li>
